...
class EliteEngine {
    constructor() {
        ...
        this.resetDungeon(); // 預先生成網格防止渲染崩潰
        this.initEvents();
        this.resize();
        this.gameLoop();
    }
    ...
    handleMove(code) {
        ...
        if (nx >= 0 && nx < this.gridW && ny >= 0 && ny < this.gridH) {
            ...
            // Level win condition: reach edges after score > X?
